...
class SubscribersController extends Controller
{
    public function index()
    {
        ...
        $pageTitle = 'Все подписчики';

        $banner = Subscribers::get();

        return view('admin.subscribers.index', compact('banner', 'breadcrumbs', 'pageTitle'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('message', 'Подписчик отредактирован');
